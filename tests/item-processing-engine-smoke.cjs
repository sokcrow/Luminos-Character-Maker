...
(async () => {
  ...
  assert.equal(flour.processedStabilization, 0);
  ...
  assert.equal(dough.processedStabilization, 2);
  ...
  assert.equal(syrup.processedStabilization, 2);
  ...
  assert.equal(smokedWolf.processedStabilization, 2);
