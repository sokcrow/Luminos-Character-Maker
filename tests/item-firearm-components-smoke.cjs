...
(async () => {
  ...
  assert.equal(Parts.get('compact_frame').icon, 'Assets/Icons/items/equipment/weapon_component_firearm_frame.png');
  assert.equal(Parts.get('sights').icon, 'Assets/Icons/items/equipment/weapon_component_firearm_sights.png');
