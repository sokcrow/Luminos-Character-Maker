  ...
  const DEFINITIONS = deepFreeze({
    ...
    aasimar_protector_transformation: {
      ...
      rules: [
        ...
        { id: "aasimar_protector_damage", type: "modifier", trigger: "damage_dealt", target: "self", path: "damage.amount", mode: "add", formula: "floor(Level / 10)", scope: "once_per_turn", whileStatus: "aasimar_protector_form" },
      ],
    },
    ...
    aasimar_scourge_transformation: {
      ...
      description: "Scourge transformation for Count 6. Once per Turn adds Level/10 Radiant Fixed Damage; aura damage is exposed for encounter resolution.",
      source: raceSource("aasimar"),
      contexts: ["combat"],
      activation: { type: "manual", actionCost: "action", uses: { max: 1, reset: "long_rest" } },
      ...
      rules: [
        ...
        { id: "aasimar_scourge_damage", type: "modifier", trigger: "damage_dealt", target: "self", path: "damage.amount", mode: "add", formula: "floor(Level / 10)", scope: "once_per_turn", whileStatus: "aasimar_scourge_form" },
      ],
    },
    ...
    aasimar_fallen_transformation: {
      ...
      description: "Fallen transformation for Count 6. Once per Turn adds Level/10 Necrotic Fixed Damage; activation exposes the Frightened check request.",
      source: raceSource("aasimar"),
      contexts: ["combat"],
      activation: { type: "manual", actionCost: "action", uses: { max: 1, reset: "long_rest" } },
      ...
      rules: [
        ...
        { id: "aasimar_fallen_damage", type: "modifier", trigger: "damage_dealt", target: "self", path: "damage.amount", mode: "add", formula: "floor(Level / 10)", scope: "once_per_turn", whileStatus: "aasimar_fallen_form" },
      ],
    },
    ...
    half_dragon_relentless_strength: {
      ...
      activation: { type: "automatic", actionCost: "none" },
      effects: [
        { id: "half_dragon_relentless_strength_normal", contexts: ["combat"], trigger: "damage_dealt", conditions: [{ path: "skill.tags", operator: "contains", value: "dragon_breath" }, { not: { path: "self.statusEffects.dragon_form", operator: "truthy" } }], operations: [{ type: "modify", path: "damage.amount", mode: "add", formula: "max(0, ConstitutionMod)" }] },
        { id: "half_dragon_relentless_strength_form", contexts: ["combat"], trigger: "damage_dealt", conditions: [{ path: "skill.tags", operator: "contains", value: "dragon_breath" }, { path: "self.statusEffects.dragon_form", operator: "truthy" }], operations: [{ type: "modify", path: "damage.amount", mode: "add", formula: "2 * max(0, ConstitutionMod)" }] },
      ],
      rules: [],
    },
