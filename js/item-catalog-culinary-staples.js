(function (global) {
  ...
  const ITEMS = Object.freeze([
    item({
      id:"egg", name:"Egg", group:"animal_product", iconFamily:"egg", standardUnitValueAhn:1800, taste:2,
    ...
    item({
      id:"milk", name:"Milk", group:"dairy", iconFamily:"milk", standardUnitValueAhn:2200, taste:2,
    ...
    item({
      id:"seaweed", name:"Seaweed", group:"aquatic_produce", iconFamily:"seaweed", standardUnitValueAhn:1800, taste:2,
    ...
    item({
      id:"avocado", name:"Avocado", group:"fruit", iconFamily:"avocado", standardUnitValueAhn:3200, taste:3,
    ...
    item({
      id:"honey", name:"Honey", group:"sweetener", iconFamily:"honey", standardUnitValueAhn:3800, taste:4,
    ...
    item({
      id:"sugar_cane", name:"Sugar Cane", group:"sweetener_crop", iconFamily:"sugar_cane", standardUnitValueAhn:1400, taste:3,
    ...
    item({
      id:"water", name:"Water", group:"liquid", iconFamily:"water", standardUnitValueAhn:500, taste:1,
    ...
    item({
      id:"salt", name:"Salt", group:"seasoning", iconFamily:"salt", standardUnitValueAhn:1200, taste:0,
    ...
    item({
      id:"yeast", name:"Yeast", group:"culture", iconFamily:"yeast", standardUnitValueAhn:1800, taste:0,
    ...
    item({
      id:"beeswax", name:"Beeswax", group:"culinary_material", iconFamily:"beeswax", standardUnitValueAhn:2400, taste:0,
    ...
    item({
      id:"gelatin", name:"Gelatin", group:"culinary_material", iconFamily:"gelatin", standardUnitValueAhn:2200, taste:0,
    ...
    item({
      id:"jellyfish", name:"Jellyfish", group:"aquatic_protein", iconFamily:"jellyfish", standardUnitValueAhn:3500, taste:1,
    ...
    item({
      id:"recycled_protein", name:"Recycled Protein", group:"city_survival", iconFamily:"recycled_protein", standardUnitValueAhn:2500, taste:0,
