(function (global) {
  ...
  const ITEMS = Object.freeze([
    ...
    ingredient("medicinal_herb", "Medicinal Herb", "medicinal_toxic_herb", "herb_healing", 1000, ["medicinal_herb"], ["bitter"], ["medicinal", "healing_reagent"], ["medicine", "alchemy"]),
    ingredient("bitterroot", "Bitterroot", "medicinal_toxic_herb", "herb_antidote", 1500, ["medicinal_herb", "root"], ["bitter"], ["medicinal", "digestive_reagent"], ["medicine", "alchemy"]),
    ingredient("feverleaf", "Feverleaf", "medicinal_toxic_herb", "herb_healing", 1800, ["medicinal_herb", "leaf"], ["bitter"], ["medicinal", "fever_reagent"], ["medicine", "alchemy"]),
    ingredient("bloodleaf", "Bloodleaf", "medicinal_toxic_herb", "herb_healing", 2000, ["medicinal_herb", "leaf"], ["earthy"], ["medicinal", "recovery_reagent"], ["medicine", "alchemy"]),
    ingredient("calming_herb", "Calming Herb", "medicinal_toxic_herb", "herb_calming", 2000, ["medicinal_herb"], ["aromatic"], ["medicinal", "calming", "tea"], ["medicine", "alchemy"]),
    ingredient("toxic_herb", "Toxic Herb", "medicinal_toxic_herb", "herb_toxic", 1500, ["toxic_herb"], ["bitter"], ["toxic", "poison_reagent"], ["poison", "alchemy"]),
    ingredient("nightshade", "Nightshade", "medicinal_toxic_herb", "herb_toxic", 3000, ["toxic_herb"], ["bitter"], ["toxic", "potent_toxin"], ["poison", "alchemy"]),
    ingredient("exotic_medicinal_herb", "Exotic Medicinal Herb", "medicinal_toxic_herb", "herb_healing", 7500, ["medicinal_herb"], ["exotic"], ["medicinal", "advanced_reagent", "rare"], ["medicine", "alchemy"]),
