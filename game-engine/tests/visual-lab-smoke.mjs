...
assert.match(game, /fittedMappedMaterial\(mat\(kind\),tilesW,tilesD\)\.clone\(\)/);
assert.match(game, /fittedMappedMaterial\(mat\(module\.topKind\|\|'groveStone'\),Math\.max\(\.01,x1-x0\),Math\.max\(\.01,z1-z0\)\)\.clone\(\)/);
