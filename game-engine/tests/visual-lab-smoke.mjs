...
assert.match(game, /largeSpeed:\[-\.070,0\]/);
assert.match(game, /smallSpeed:\[-\.095,0\]/);
assert.match(game, /foamSpeed:\[-\.115,0\]/);
assert.match(game, /riverToon\.prepareGeometry\(geo/);
assert.match(game, /reactiveBuoyancy=!!riverToon/);
assert.match(game, /ToonWater already owns animated waves\/foam and reactive ripples/);
