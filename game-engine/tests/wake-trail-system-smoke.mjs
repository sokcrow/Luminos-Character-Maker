...
assert.match(src,/1\\.0-vUv\\.x\+uUvOffset/,'directional wake texture must be mirrored longitudinally');
assert.match(src,/this\\.uvOffset\+finite\(this\\.config\\.scrollSpeed/,'mirrored texture must still scroll away from origin/downstream');
